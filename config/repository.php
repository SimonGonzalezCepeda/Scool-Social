...
return [
    ...
    */
    'generator'  => [
        'basePath'      => base_path(). '/vendor/scool/social/notification/src',
        'databasePath'  => base_path(). '/vendor/scool/social/notification/database',
        'rootNamespace' => 'Scool\\Social\\Notifications\\',
